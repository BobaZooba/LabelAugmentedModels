...
# from label_augmented import models
#
#
...
#
# # backbone = models.MemoryAugmentedBert(
...
# # )
#
# # backbone = models.MemoryAugmentedTransformer(
# #     model_dim=model_dim,
...
#
# head = models.MultiLayerPerceptron(sizes=head_sizes)
#
# model = nn.Sequential()
